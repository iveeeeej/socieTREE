...
body{
    background: linear-gradient(135deg, rgba(57, 66, 77, 0.5) 0%, rgba(6, 73, 117, 0.9) 100%), url('../img/1.png');
    ...
    <!-- LEFT BOX -->
            ...
            <div class="col-md-6 d-flex justify-content-center align-items-center flex-column left-box">
                <div class="featured-image mb-3 text-center w-100">
                    <img src="../img/Icon-NOBG.png" alt="USG Logo" class="img-fluid" style="max-width: 250px; height: auto;">
                </div>
            </div>
